...
_TRANSLATIONS: dict[Language, dict[str, str]] = {
    LANGUAGE_ZH: {
        ...
        "main.dialog.title.reset_database": "重置数据库",
    ...
    LANGUAGE_EN: {
        ...
        "startup.use_previous_db": "Use previous databases (do not clear the data folder)",
        ...
        "main.dialog.title.reset_database": "Reset Database",
