...
_TRANSLATIONS: dict[Language, dict[str, str]] = {
    LANGUAGE_ZH: {
        ...
        "startup.unexpected_error": "加载数据时发生意外错误。",
        "main.unexpected_error": "操作时发生意外错误。",
        ...
        "main.status.beatmaps_imported": "已导入 {package_count} 个谱面包，共 {beatmap_count} 张谱面",
        ...
        "main.dialog.title.import_beatmaps": "导入谱面",
        "main.dialog.title.import_beatmaps_failed": "导入谱面失败",
    ...
    LANGUAGE_EN: {
        ...
        "menu.language.en": "English",
        "action.import_beatmaps": "Import Beatmaps",
        ...
        "startup.unexpected_error": "An unexpected error occurred while loading data.",
        "main.unexpected_error": "An unexpected error occurred while processing the request.",
        ...
        "main.status.beatmaps_imported": "Imported {package_count} beatmap packages with {beatmap_count} beatmaps",
        ...
        "main.dialog.title.import_beatmaps": "Import Beatmaps",
        "main.dialog.title.import_beatmaps_failed": "Import Beatmaps Failed",
