...
class BeatmapRecord(SQLModel, table=True):
	...
	drain_time: int = Field(default=0)
	...
	hit_circle_count: int = Field(default=0)
	slider_count: int = Field(default=0)
	spinner_count: int = Field(default=0)
	last_modified: int = Field(default=0)
	preview_time: int = Field(default=0)
	is_unplayed: bool = Field(default=False)
	last_played: int = Field(default=0)
	is_osz2: bool = Field(default=False)
	folder_name: str = Field(default="")
	last_checked: int = Field(default=0)
